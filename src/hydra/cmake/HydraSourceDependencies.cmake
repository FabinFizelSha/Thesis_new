...
# nanoflann is header-only. Do not add_subdirectory(nanoflann),
# because its CMakeLists creates an "uninstall" target that conflicts
# with ament/ROS builds.
if(NOT TARGET nanoflann::nanoflann)
  add_library(nanoflann::nanoflann INTERFACE IMPORTED GLOBAL)
  set_target_properties(
    nanoflann::nanoflann
    PROPERTIES
      INTERFACE_INCLUDE_DIRECTORIES "${nanoflann_SOURCE_DIR}/include"
  )
endif()
