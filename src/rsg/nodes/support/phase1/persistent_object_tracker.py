...
class PersistentObjectTracker:
    ...
    def prepare_frame_assignments(self, observations: List[Dict[str, Any]]) -> List[bool]:
        ...
        *,
        ...
        for track_id in self._candidate_track_ids(centroid, bbox_3d_min, bbox_3d_max):
            ...
            row: Dict[str, Any] = {
                ...
                "candidate_centroid_3d": _as_list(track.centroid_3d),
                "candidate_bbox_3d_min": _as_list(track.bbox_3d_min),
                "candidate_bbox_3d_max": _as_list(track.bbox_3d_max),
                "candidate_last_bbox_3d_min": _as_list(track.last_bbox_3d_min),
                "candidate_last_bbox_3d_max": _as_list(track.last_bbox_3d_max),
